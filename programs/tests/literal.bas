...
140 A$="JOIN"+"ED":E=PEEK(V+1)+256*PEEK(V+2):IF E<32768 OR A$<>"JOINED" OR PEEK(E-65536)<>74 THEN PRINT "FAIL a joined string is not in string space";E:F=1
...
230 POKE Z+1,0:POKE Z+2,60:POKE Z+1,ZA-256*INT(ZA/256):POKE Z+2,INT(ZA/256)
